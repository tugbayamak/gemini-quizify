...
if __name__ == "__main__":
    ...
    with screen.container():
        ...
        chroma_creator = ChromaCollectionCreator(
            document_processor, embed_client)
        ...
        with st.form("Load Data to Chroma"):
            ...
            # Prompt user to input quiz topic
            quiz_topic = st.text_input("Enter the quiz topic:")

            # Select the desired number of questions using a slider component
            num_questions = st.slider(
                "Select the number of questions", min_value=1, max_value=10, value=1)
