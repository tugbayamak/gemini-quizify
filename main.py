        ...
        with screen.container():
            ...
            with st.form("Load Data to Chroma"):
                ...
                if submitted:
                    ...
                    generator = QuizGenerator(topic, num_questions, chroma_creator) # Step 3: Initialize a QuizGenerator class using the topic, number of questrions, and the chroma collection
